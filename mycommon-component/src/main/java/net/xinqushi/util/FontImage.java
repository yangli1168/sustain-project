...
public class FontImage {
	 ...
	 * @throws IOException
	 */
	public static void getImage(String content, Font font, Integer width, Integer height, String destPath)
			throws IOException {
		mkdirs(destPath);
	 ...
	 * @throws IOException
	 */
	public static void getImage(String content, Font font, Integer width, Integer height, OutputStream output)
			throws IOException {
	...
	public static void main(String[] args) throws Exception {
		getImage(IdentifyingCodeUtils.makeIdentifyingWords(4), 300, 150, "d:/test");
