...
public interface CommonCacheManager {
	...
	public void cacheNx(@RequestParam("key") String key, @RequestParam("value") String value,
	        @RequestParam("timeout") int timeout) throws CommonException;
	...
	public void hset(@PathVariable("key") String key, @RequestParam("field") String field, @RequestParam("value") String value) throws CommonException;
